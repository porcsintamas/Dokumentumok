# CCNA 1 v7.0 záróvizsga válaszok teljeskörűen – Bevezetés a hálózatokba
...
**4. Melyik típusú szerver támaszkodik olyan rekordtípusokra, mint az A, NS, AAAA és MX a szolgáltatások nyújtásához?**
*   ***DNS***
*   e-mail
*   fájl
*   web
...
**10. Melyik jellemző ír le egy vírust?**
...
**15. Lásd az ábrát. Melyik eszköz interfészének IP-címét kell használni a H1 hoszt alapértelmezett átjáró beállításaként?**
...
**22. Egy klienscsomagot fogad egy szerver. A csomag célportjának száma 53. Milyen szolgáltatást kér a kliens?**
*   ***DNS***
*   NetBIOS (NetBT)
*   POP3
*   IMAP
...
**29. Melyik jellemző ír le egy DoS (szolgáltatásmegtagadási) támadást?**
*   lopott hitelesítő adatok használata magánadatokhoz való hozzáféréshez
*   egy hálózati eszköz, amely szűri a hálózatba érkező hozzáférést és forgalmat
...
**34. Mit jelent az „attenuation” (csillapítás/gyengülés) kifejezés az adatkommunikációban?**
...
**45. Mi a következménye annak, ha egy routert az `ipv6 unicast-routing` globális konfigurációs paranccsal konfigurálnak?**
...
**50. Egy hálózati rendszergazda új LAN-t ad hozzá egy fiókirodához. Az új LAN-nak 90 csatlakoztatott eszközt kell támogatnia. Mi a legkisebb hálózati maszk, amelyet a hálózati rendszergazda használhat az új hálózathoz?**
*   ***255.255.255.128***
*   255.255.255.240
*   255.255.255.248
*   255.255.255.224
...
**55. Melyik két funkciót látja el az OSI adatkapcsolati réteg LLC alrétege az Ethernet kommunikáció megkönnyítése érdekében? (Válasszon kettőt!)**
...
**56. Az `ip default-gateway 172.16.100.1` globális konfigurációs parancsot egy switch-en alkalmazzák. Mi a parancs hatása?**
...
**62. Melyik két probléma okozható nagyszámú ARP kérés és válasz üzenet által? (Válasszon kettőt!)**
...
**66. Egy hálózati rendszergazda privátban szeretné tartani a felhasználói azonosítót, jelszót és a munkamenet tartalmát, amikor távoli CLI kapcsolatot létesít egy switch-csel annak menedzseléséhez. Melyik hozzáférési módszert kell választania?**
*   Telnet
*   AUX
*   ***SSH***
*   Konzol
...
**72. Melyik két biztonsági megoldást használják legvalószínűbben csak vállalati környezetben? (Válasszon kettőt!)**
...
**81. Egy új hálózati rendszergazdát felkértek, hogy adjon meg egy üdvözlő üzenetet (banner message) egy Cisco eszközön. Mi a leggyorsabb módja annak, hogy egy hálózati rendszergazda tesztelje, hogy az üdvözlő üzenet megfelelően van-e konfigurálva?**
...
**88. Milyen szolgáltatást nyújt az FTP?**
*   Alapvető szabálykészlet szövegek, grafikus képek, hangok, videók és egyéb multimédiás fájlok cseréjére a weben.
*   Egy alkalmazás, amely valós idejű csevegést tesz lehetővé távoli felhasználók között.
*   ***Lehetővé teszi az adatátvitelt egy kliens és egy fájlszerver között.***
*   Titkosítást használ a szövegek, grafikus képek, hangok és videók cseréjének biztonságossá tételéhez a weben.
...
**93. Milyen szolgáltatást nyújt a BOOTP?**
*   Titkosítást használ a szövegek, grafikus képek, hangok és videók cseréjének biztonságossá tételéhez a weben.
*   Lehetővé teszi az adatátvitelt egy kliens és egy fájlszerver között.
...
**99. Párosítsa az egyes keretmező típusokat a funkciójukkal. (Nem minden opció használatos.)**
...
**103. Hogyan növeli a `service password-encryption` parancs a jelszóbiztonságot a Cisco routereken és switcheken?**
...
**107. Egy hálózati rendszergazda új LAN-t ad hozzá egy fiókirodához. Az új LAN-nak 200 csatlakoztatott eszközt kell támogatnia. Mi a legkisebb hálózati maszk, amelyet a hálózati rendszergazda használhat az új hálózathoz?**
*   255.255.255.240
*   ***255.255.255.0***
*   255.255.255.248
*   255.255.255.224
...
**113. Lásd az ábrát. Melyik két hálózati cím rendelhető hozzá a 10 hosztot tartalmazó hálózathoz? Válaszainak a legkevesebb címet kell pazarolniuk, nem szabad újra felhasználniuk a már hozzárendelt címeket, és a 10.18.10.0/24 címtartományon belül kell maradniuk. (Válasszon kettőt!)**
...
**129. Melyik két ICMPv6 üzenettípust kell engedélyezni az IPv6 hozzáférés-vezérlési listákon keresztül ahhoz, hogy a Layer 3 címek Layer 2 MAC-címekre történő feloldása lehetővé váljon? (Válasszon kettőt!)**
...
**135. Mi a felhőalapú számítástechnika (cloud computing) használatának egyik előnye a hálózatépítésben?**
...
*   ***A hálózati képességek kibővülnek anélkül, hogy új infrastruktúrába, személyzetbe vagy szoftverbe kellene beruházni.***
*   A végfelhasználóknak szabadságuk van személyes eszközeiket használni az információk eléréséhez és a kommunikációhoz egy üzleti hálózaton keresztül.
*   Az otthoni hálózatépítés meglévő elektromos vezetékeket használ az eszközök hálózathoz való csatlakoztatására bárhol, ahol elektromos csatlakozó van, megtakarítva az adatkábelek telepítésének költségeit.
> **Magyarázat:** A felhőalapú számítástechnika kibővíti az IT képességeit anélkül, hogy új infrastruktúrába kellene beruházni, új személyzetet kellene képezni, vagy új szoftvereket kellene licencelni. Ezek a szolgáltatások igény szerint elérhetők, és gazdaságosan eljuttathatók bármely eszközhöz bárhol a világon anélkül, hogy a biztonságot vagy a funkciót veszélyeztetnék. A BYOD (Bring Your Own Device – Hozd a saját eszközödet) arról szól, hogy a végfelhasználóknak szabadságuk van személyes eszközeiket használni az információk eléréséhez és a kommunikációhoz egy üzleti vagy egyetemi hálózaton keresztül. Az okosotthon-technológia integrálódik a mindennapi készülékekbe, lehetővé téve számukra, hogy összekapcsolódjanak más eszközökkel, így „okosabbá” vagy automatizáltabbá válnak. Az elektromos hálózaton keresztüli hálózatépítés (powerline networking) egy otthoni hálózatépítési trend, amely meglévő elektromos vezetékeket használ az eszközök hálózathoz való csatlakoztatására bárhol, ahol elektromos csatlakozó van, megtakarítva az adatkábelek telepítésének költségeit.

**136. Melyik két állítás helyes a MAC- és IP-címekről az adatátvitel során, ha NAT nincs bevonva? (Válasszon kettőt!)**
*   ***A csomagfejlécben lévő cél IP-címek állandóak maradnak a célhoszthoz vezető teljes útvonalon.***
*   A cél MAC-címek soha nem változnak meg egy olyan keretben, amely hét routeren halad keresztül.
*   Minden alkalommal, amikor egy keretet új cél MAC-címmel ágyaznak be, új cél IP-címre van szükség.
*   ***A cél és forrás MAC-címek helyi jelentőséggel bírnak, és minden alkalommal megváltoznak, amikor egy keret egyik LAN-ról a másikra kerül.***
*   Egy csomag, amely négy routeren haladt át, négyszer változtatta meg a cél IP-címét.

**137. Mi az adatkapcsolati réteg egyik fő jellemzője?**
*   Generálja azokat az elektromos vagy optikai jeleket, amelyek az 1-eseket és 0-kat képviselik a médián.
*   Egy adatbitfolyamot egy előre definiált kódra konvertál.
*   ***Megvédi a felsőbb réteg protokollját attól, hogy tudomása legyen a kommunikációban használandó fizikai közegről.***
*   Elfogadja a Layer 3 csomagokat, és eldönti, hogy melyik útvonalon továbbítsa a csomagot egy távoli hálózatra.

**138. Melyik három a CSMA/CD folyamat jellemzője? (Válasszon hármat!)**
*   Az elektronikus vezérjellel (token) rendelkező eszköz az egyetlen, amely ütközés után továbbíthat.
*   ***Egy eszköz figyel, és addig vár, amíg a média nem foglalt, mielőtt továbbítana.***
*   ***Ütközés észlelése után a hosztok véletlenszerű időkésleltetés lejárta után megpróbálhatják folytatni a továbbítást.***
*   ***Egy szegmensen lévő összes eszköz látja a hálózati médián áthaladó adatokat.***
*   Egy zavaró jel (jam signal) jelzi, hogy az ütközés megszűnt, és a média nem foglalt.
*   Az eszközök magasabb továbbítási prioritással konfigurálhatók.
> **Magyarázat:** A Vivőérzékeléses Többszörös Hozzáférés/Ütközésészlelés (Carrier Sense Multiple Access/Collision Detection, CSMA/CD) folyamat egy versengésen alapuló médiahozzáférés-vezérlési mechanizmus, amelyet megosztott médiahozzáférésű hálózatokon, például Etherneten használnak. Amikor egy eszköznek adatokat kell továbbítania, figyel, és addig vár, amíg a média elérhető (csendes), majd adatokat küld. Ha két eszköz egyszerre továbbít, ütközés következik be. Mindkét eszköz észleli az ütközést a hálózaton. Amikor egy eszköz ütközést észlel, leállítja az adattovábbítási folyamatot, vár egy véletlenszerű ideig, majd újra próbálkozik.

**139. Milyen információt jelenít meg a `show startup-config` parancs?**
*   a RAM-ba másolt IOS image-et
*   a ROM-ban lévő bootstrap programot
*   az aktuális futó konfigurációs fájl tartalmát a RAM-ban
*   ***a mentett konfigurációs fájl tartalmát az NVRAM-ban***
> **Magyarázat:**
> A `show startup-config` parancs megjeleníti az NVRAM-ban található mentett konfigurációt. A `show running-config` parancs megjeleníti az aktuálisan futó, RAM-ban található konfigurációs fájl tartalmát.

**140. Melyik két parancs használható egy Windows hoszton az útválasztási tábla megjelenítésére? (Válasszon kettőt!)**
*   netstat -s
*   ***route print***
*   show ip route
*   ***netstat -r***
*   tracert
> **Magyarázat:**
> Egy Windows hoszton a `route print` vagy a `netstat -r` parancsok használhatók a hoszt útválasztási táblájának megjelenítésére. Mindkét parancs ugyanazt a kimenetet generálja. Egy routeren a `show ip route` parancsot használják az útválasztási tábla megjelenítésére. A `netstat –s` parancsot protokollonkénti statisztikák megjelenítésére használják. A `tracert` parancsot annak az útvonalnak a megjelenítésére használják, amelyet egy csomag a céljáig bejár.

**141. Melyik két funkciót biztosítja a hálózati réteg? (Válasszon kettőt!)**
*   ***adatcsomagok irányítása más hálózatokon lévő célhosztokhoz***
*   adatok elhelyezése a hálózati médián
*   adatok szállítása a forrás- és célhosztokon futó folyamatok között
*   dedikált végpontok közötti kapcsolatok biztosítása
*   ***egyedi hálózati azonosító biztosítása a végponti eszközök számára***
> **Magyarázat:** A hálózati réteg elsősorban az adatok továbbításával foglalkozik egy forrásból egy másik hálózaton lévő célhoz. Az IP-címek egyedi azonosítókat biztosítanak a forrás és a cél számára. A hálózati réteg kapcsolat nélküli, legjobb szándékú (best-effort) kézbesítést biztosít. Az eszközök a magasabb rétegekre támaszkodnak a folyamatoknak nyújtott szolgáltatások biztosításában.

**142. Melyik két állítás írja le egy router IPv4 útválasztási táblájának jellemzőit? (Válasszon kettőt!)**
*   A közvetlenül csatlakoztatott interfészeknek két útvonalforrás-kódja lesz az útválasztási táblában: C és S .
*   Ha két vagy több lehetséges útvonal van ugyanahhoz a célhoz, a magasabb metrikaértékkel rendelkező útvonal kerül be az útválasztási táblába.
*   A `netstat -r` parancs használható egy router útválasztási táblájának megjelenítésére.
*   Az útválasztási tábla felsorolja minden aktív interfész MAC-címét.
*   ***Információkat tárol az aktív router interfészekből származó útvonalakról.***
*   ***Ha egy alapértelmezett statikus útvonal van konfigurálva a routerben, egy bejegyzés kerül az útválasztási táblába S forráskóddal.***

**Másik eset:**
*   A `netstat -r` parancs használható egy router útválasztási táblájának megjelenítésére.
*   ***Az útválasztási tábla információkat tárol az aktív router interfészekből származó útvonalakról.***
*   Az útválasztási tábla felsorolja minden aktív interfész MAC-címét.
*   A közvetlenül csatlakoztatott interfészeknek két útvonalforrás-kódja lesz az útválasztási táblában: C és S .
*   ***Ha egy alapértelmezett statikus útvonal van konfigurálva a routerben, egy bejegyzés kerül az útválasztási táblába S forráskóddal***
> **Magyarázat:** A `show ip route` parancsot használják a router útválasztási táblájának megjelenítésére. IPv4-ben a közvetlenül csatlakoztatott interfészeknek egy forráskódja lesz: **C**. Az útválasztási tábla információkat tárol a közvetlenül csatlakoztatott útvonalakról és a távoli útvonalakról. Egy bejegyzés az útválasztási táblában **S** forráskóddal akkor kerül be, ha egy alapértelmezett statikus útvonal van konfigurálva a routeren.

**143. Melyik jellemző írja le a VPN-t?**
*   egy routeren lévő szoftver, amely IP-címek vagy alkalmazások alapján szűri a forgalmat
*   gyorsan terjedő fenyegetéseket azonosító szoftver
*   ***egy alagútkezelő protokoll, amely biztonságos hozzáférést biztosít távoli felhasználóknak egy szervezet hálózatához***
*   egy hálózati eszköz, amely szűri a hálózatba érkező hozzáférést és forgalmat

**144. Miért lenne szüksége egy Layer 2 switchnek IP-címre?**
*   hogy a switch broadcast kereteket tudjon küldeni a csatlakoztatott PC-knek
*   hogy a switch alapértelmezett átjáróként tudjon funkcionálni
*   ***hogy a switch távolról menedzselhető legyen***
*   hogy a switch kereteket tudjon fogadni a csatlakoztatott PC-ktől
> **Magyarázat:** Egy switchnek, mint Layer 2 eszköznek, nincs szüksége IP-címre a keretek továbbításához a csatlakoztatott eszközökhöz. Azonban, amikor egy switch-et távolról érnek el a hálózaton keresztül, rendelkeznie kell egy Layer 3 címmel. Az IP-címet egy virtuális interfészre kell alkalmazni, nem pedig egy fizikai interfészre. A routerek, nem a switchek, funkcionálnak alapértelmezett átjáróként.

**145. Párosítsa az egyes leírásokat a megfelelő kifejezéssel. (Nem minden opció használatos.)**
![Kép](https://itexamanswers.net/wp-content/uploads/2019/12/2024-11-19_102334.jpg)
| Leírás           | Kifejezés                                                                     |
|-----------------------|--------------------------------------------------------------------------|
| üzenet beágyazása (message encapsulation) | ***az a folyamat, amikor egy üzenetformátumot egy másik üzenetformátumba helyeznek***    |
| üzenet méretezése (message sizing)        | ***egy hosszú üzenet egyedi darabokra bontásának folyamata, mielőtt a hálózaton keresztül elküldenék*** |
| üzenet kódolása (message encoding)      | ***az információ egyik formátumból egy másik, továbbításra elfogadható formátumba való átalakításának folyamata*** |

**146. Egy felhasználó HTTP kérést küld egy webszervernek egy távoli hálózaton. E kérés beágyazása során milyen információ kerül a keret címmezőjébe a cél jelzésére?**
*   a célhoszt hálózati tartománya
*   az alapértelmezett átjáró IP-címe
*   a célhoszt MAC-címe
*   ***az alapértelmezett átjáró MAC-címe***
> **Magyarázat:** Egy keretet forrás és cél MAC-címekkel ágyaznak be. A forráseszköz nem fogja ismerni a távoli hoszt MAC-címét. A forrás ARP kérést küld, amelyre a router válaszolni fog. A router az interfészének MAC-címével válaszol, azzal, amely ugyanahhoz a hálózathoz csatlakozik, mint a forrás.

**147. Mi az előnye egy nyílt szabvány által definiált protokoll használatának?**
*   Egy vállalat monopolizálhatja a piacot.
*   A protokoll csak egy adott gyártó berendezésein futtatható.
*   Egy nyílt szabványú protokollt nem ellenőriznek vagy szabályoznak szabványügyi szervezetek.
*   ***Ösztönzi a versenyt és elősegíti a választási lehetőségeket.***
> **Magyarázat:**
> Egy vállalat monopóliuma nem jó ötlet felhasználói szempontból. Ha egy protokoll csak egy márkán futtatható, az megnehezíti a vegyes berendezések használatát egy hálózatban. Egy proprietáris protokoll nem használható ingyenesen. Egy nyílt szabványú protokollt általában széles körű gyártók implementálnak.

**148. Adatokat küldenek egy forrás PC-ről egy célszerverre. Melyik három állítás írja le helyesen a TCP vagy UDP funkcióját ebben a helyzetben? (Válasszon hármat!)**
*   ***A forrásport mező azonosítja azt a futó alkalmazást vagy szolgáltatást, amely a PC-re visszatérő adatokat kezeli.***
*   A PC-n futó TCP folyamat véletlenszerűen választja ki a célportot, amikor munkamenetet létesít a szerverrel.
*   ***Az UDP szegmenseket IP-csomagokba ágyazzák a hálózaton keresztüli szállításhoz.***
*   ***Az UDP célport száma azonosítja a szerveren lévő alkalmazást vagy szolgáltatást, amely az adatokat kezeli.***
*   A TCP az előnyben részesített protokoll, amikor egy funkció alacsonyabb hálózati terhelést igényel.
*   A TCP forrásport száma azonosítja a küldő hosztot a hálózaton.
> **Magyarázat:** A Layer 4 portszámok azonosítják azt az alkalmazást vagy szolgáltatást, amely az adatokat kezeli. A forrásport számot a küldő eszköz adja hozzá, és ez lesz a célport száma, amikor a kért információ visszatér. A Layer 4 szegmenseket IP-csomagokba ágyazzák. Az UDP-t, nem a TCP-t, akkor használják, ha alacsony terhelésre van szükség. Egy forrás IP-cím, nem pedig egy TCP forrásport szám, azonosítja a küldő hosztot a hálózaton. A célport számok specifikus portok, amelyeket egy szerveralkalmazás vagy szolgáltatás figyel a kérésekre.

**149. Párosítsa az egyes leírásokat a megfelelő TCP mechanizmussal. (Nem minden opció használatos.)**
![Kép](https://itexamanswers.net/wp-content/uploads/2020/01/20.jpg)
| Leírás                                                                 | TCP Mechanizmus   |
|-----------------------------------------------------------------------------|-----------------|
| az a bájtokban kifejezett mennyiség, amelyet egy céleszköz egyszerre képes fogadni és feldolgozni     | ***ablakméret (window size)***     |
| hiányzó adatszegmensek azonosítására szolgál                                   | ***sorszámok (sequence numbers)***|
| adatszegmensek elvesztésének kezelési módja                                    | ***újraküldés (retransmission)***  |
| egy küldő által fogadott jelzés, mielőtt több szegmenst továbbítana egy munkamenetben         | ***nyugta (acknowledgment)***  |

**150. Lásd az ábrát. Egy vállalat a 128.107.0.0/16 címblokkot használja a hálózatához. Melyik alhálózati maszk biztosítaná a maximális számú azonos méretű alhálózatot, miközben elegendő hosztcímet biztosítana minden alhálózathoz az ábrán?**
![Kép](https://itexamanswers.net/wp-content/uploads/2020/01/i207609v1n1_207609.png)
*   255.255.255.192
*   255.255.255.0
*   ***255.255.255.128***
*   255.255.255.240
*   255.255.255.224
> **Magyarázat:** A topológia legnagyobb alhálózata 100 hosztot tartalmaz, tehát az alhálózati maszknak legalább 7 hosztbitet kell tartalmaznia (2<sup>7</sup>-2=126). A 255.255.255.0 8 hosztbitet tartalmaz, de ez nem felel meg annak a követelménynek, hogy a maximális számú alhálózatot biztosítsa. A 255.255.255.128 (/25) maszk 7 hosztbitet biztosít.

**151. Egy hálózati rendszergazda ugyanazt az alhálózati maszkot szeretné használni három alhálózathoz egy kis telephelyen. A telephelyen a következő hálózatok és eszközök száma található:**

- *A alhálózat: IP telefonok – 10 cím*
- *B alhálózat: PC-k – 8 cím*
- *C alhálózat: Nyomtatók – 2 cím*

**Melyik egyetlen alhálózati maszk lenne megfelelő a három alhálózathoz?**
*   255.255.255.0
*   ***255.255.255.240***
*   255.255.255.248
*   255.255.255.252
> **Magyarázat:**
> Ha ugyanazt a maszkot kell használni, akkor a legtöbb hosztot tartalmazó hálózatot kell megvizsgálni a hosztok száma szempontjából. Mivel ez 10 hoszt, 4 hosztbitre van szükség (2<sup>4</sup>-2 = 14 hoszt). A /28 vagy 255.255.255.240 alhálózati maszk lenne megfelelő ezekhez a hálózatokhoz.

**152. Párosítsa az egyes elemeket ahhoz a topológiai diagram típushoz, amelyen jellemzően azonosítják őket. (Nem minden opció használatos.)**
![Kép](https://itexamanswers.net/wp-content/uploads/2020/01/24.jpg)
| fizikai topológiai diagram                               | logikai topológiai diagram |
|---------------------------------------------------------|--------------------------|
| ***egy asztali PC helye egy tanteremben***                 | ***egy szerver IP-címe***   |
| ***a helyiségeket a kábelezési szekrényekkel összekötő kábelek útvonala***     |                          |

Egy logikai topológiai diagram jellemzően az IP-címzési sémát és az eszközök és portok csoportosítását ábrázolja. Egy fizikai topológiai diagram megmutatja, hogyan kapcsolódnak ezek az eszközök egymáshoz és a hálózathoz, összpontosítva a köztes eszközök fizikai helyére, a konfigurált portokra és a kábelezésre.

**153. Melyik két információ jelenik meg a `show ip interface brief` parancs kimenetében? (Válasszon kettőt!)**
*   ***IP-címek***
*   interfész leírások
*   MAC-címek
*   következő ugrás (next-hop) címek
*   ***Layer 1 állapotok***
*   sebesség és duplex beállítások
> **Magyarázat:** A `show ip interface brief` parancs megjeleníti minden interfész IP-címét, valamint az interfészek működési állapotát mind a Layer 1, mind a Layer 2 szinten. Az interfész leírások és a sebesség- és duplex beállítások megtekintéséhez használja a `show running-config interface` parancsot. A következő ugrás címek az útválasztási táblában jelennek meg a `show ip route` paranccsal, és egy interfész MAC-címe a `show interfaces` paranccsal látható.

**154. Egy felhasználó panaszkodik, hogy egy külső weboldal a szokásosnál tovább töltődik be. A weboldal végül betöltődik a felhasználó gépén. Melyik eszközt kellene a technikusnak rendszergazdai jogosultságokkal használnia annak megállapítására, hogy hol van a probléma a hálózatban?**
*   ping
*   nslookup
*   ***tracert***
*   ipconfig /displaydns
> **Magyarázat:** A Parancssor `tracert` parancsa feltérképezi az útvonalat a PC-től a webszerverig, és méri a csomagok átviteli késleltetését a hálózaton keresztül.

**155. Melyik értéket, amely egy IPv4 fejlécmezőben található, csökkenti minden router, amely fogad egy csomagot?**
*   Fejléc Hossz (Header Length)
*   Megkülönböztetett Szolgáltatások (Differentiated Services)
*   ***Élettartam (Time-to-Live)***
*   Töredék Eltolás (Fragment Offset)
> **Magyarázat:** Amikor egy router fogad egy csomagot, a router eggyel csökkenti az Élettartam (TTL) mező értékét. Amikor a mező értéke eléri a nullát, a fogadó router eldobja a csomagot, és ICMP Time Exceeded (Időtúllépés) üzenetet küld a küldőnek.

**156. Egy hálózati technikus száloptikás kábelezés használatát kutatja egy új technológiai központban. Melyik két kérdést kell figyelembe venni a száloptikás média implementálása előtt? (Válasszon kettőt!)**
*   ***A száloptikás kábelezés más lezárási és toldási szakértelmet igényel, mint a rézkábelezés.***
*   A száloptikás kábelezés specifikus földelést igényel az EMI elleni védettséghez.
*   A száloptikás kábelezés érzékeny a jelveszteségre RFI miatt.
*   A száloptikás kábel képes ellenállni a durva kezelésnek.
*   ***A száloptika nagyobb adatkapacitást biztosít, de drágább, mint a rézkábelezés.***
> **Magyarázat:** A száloptikás média drágább, mint az azonos távolságon használt rézkábelezés. A száloptikás kábelek fényt használnak elektromos jel helyett, így az EMI és RFI nem jelentenek problémát. Azonban a száloptika más készségeket igényel a lezáráshoz és toldáshoz.

**157. Párosítsa az egyes leírásokat egy megfelelő IP-címmel. (Nem minden opció használatos.)**
![Kép](https://itexamanswers.net/wp-content/uploads/2019/12/2024-11-19_104050.jpg)
| Leírás             | IP-cím    |
|-------------------------|---------------|
| egy kísérleti cím | ***240.2.6.255***   |
| egy link-local (kapcsolat-helyi) cím    | ***169.254.1.5***   |
| egy nyilvános cím        | ***198.133.219.2*** |
| egy visszacsatolási (loopback) cím      | ***127.0.0.1***     |

**158. Egy felhasználó `tracert` parancsot futtat egy távoli eszközre. Melyik ponton állítaná le egy router, amely az útvonalon van a céleszköz felé, a csomag továbbítását?**
*   amikor a router ICMP Time Exceeded (Időtúllépés) üzenetet kap
*   amikor az RTT (Round Trip Time - Körutazási Idő) érték eléri a nullát
*   amikor a hoszt ICMP Echo Reply (Visszhang Válasz) üzenettel válaszol
*   ***amikor a TTL (Time-to-Live - Élettartam) mező értéke eléri a nullát***
*   amikor mind az Echo Request (Visszhang Kérés), mind az Echo Reply (Visszhang Válasz) üzenetek értéke eléri a nullát
> **Magyarázat:**
> Amikor egy router fogad egy traceroute csomagot, a TTL mező értékét 1-gyel csökkenti. Amikor a mező értéke eléri a nullát, a fogadó router nem továbbítja a csomagot, és ICMP Time Exceeded (Időtúllépés) üzenetet küld vissza a forrásnak.

**159. A felhasználók arról számolnak be, hogy a hálózati hozzáférés lassú. Az alkalmazottak kikérdezése után a hálózati rendszergazda megtudta, hogy az egyik alkalmazott letöltött egy harmadik féltől származó szkennelő programot a nyomtatóhoz. Milyen típusú rosszindulatú program (malware) kerülhetett be, amely lassú hálózati teljesítményt okoz?**
*   vírus
*   ***féreg (worm)***
*   adathalászat (phishing)
*   levélszemét (spam)
> **Magyarázat:** Egy kiberbiztonsági szakembernek ismernie kell a különböző típusú rosszindulatú programok és támadások jellemzőit, amelyek egy szervezetet fenyegetnek. (A férgek gyakran terjednek a hálózaton, és jelentős sávszélességet fogyaszthatnak, ami lassulást okoz.)
